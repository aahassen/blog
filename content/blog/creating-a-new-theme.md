...
featuredpath = "date"
linktitle = ""
title = "Microservices from A to Z"
type = "post"
...
Micro service is an architectural style/approach while dealing with an enterprise level application. 
To understand this architectural sytyle we need to review some of the most common software development architectural syle.
